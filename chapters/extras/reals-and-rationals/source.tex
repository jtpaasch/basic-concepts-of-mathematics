...
\newtopic{I}{n the last chapter} we saw \ldots
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \section{Common Measures}

% You might think that for any two lengths, you can find a smaller stick piece that they have in common. There are examples where this can be done.


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \section{Unsquaring the Number Two}

% But it cannot always be done. Try it with a right triangle with legs of length 1.

% Proof that the square root of two is not a fraction:
...
\newthought{In this chapter}, we looked at 
